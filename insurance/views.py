...
def home_view(request):
    ...
    return render(request,'insurance/Acceuil-Bicor.html')
...
def contactus_view(request):
    ...
    if request.method == 'POST':
        ...
        if sub.is_valid():
            ...
            return render(request, 'insurance/Avec_Success.html')
    #return render(request, 'insurance/contactus.html', {'form':sub})
    return render(request, 'insurance/Contact-Nous.html', {'form':sub})
